...
BTPanel 11.3.0正式版更新日志：[https://www.bt.cn/bbs/thread-19376-1-1.html](https://www.bt.cn/bbs/thread-19376-1-1.html)
...
```
* 官方安装命令：(11.3.0正式版) [CentOS/OpenCloudOS/AlibabaCloud] [默认线路]
```
